    ...
    <>
      ...
      <section className="pb-24 bg-white">
        <div className="mx-auto max-w-3xl px-5 space-y-6 text-[16px] leading-relaxed text-[var(--color-text-muted)]">
          ...
          <p><b className="text-[var(--color-text)] font-medium">{brand.name}</b> unifies analytics, replay and revenue-by-source attribution into a single, fast, self-hosted platform. Your data stays on your infrastructure, your costs stay flat, and your team gets one source of truth.</p>
