...
func Load() *Config {
	...
	viper.SetDefault("POSTGRES_DSN", "postgres://inspectuser:change_me_in_production@localhost:5432/inspectuser?sslmode=disable")
	...
	viper.SetDefault("R2_BUCKET", "inspectuser-replays")
